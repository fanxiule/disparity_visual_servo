...
public:
    ...
    {
        disp_publisher = nh.advertise<Image>("/raw_disp", 1);
        ...
        ir1_sub.subscribe(nh, "/camera/infra1/image_raw", 1);
        ir2_sub.subscribe(nh, "/camera/infra2/image_raw", 1);
...
private:
    ...
    // convert image for ROS Image ponter to CV pointer
